        ...
        {isCourseSelected ? (
          <div>
            {courseInfo?.resourceUrls &&
              courseInfo?.resourceUrls.map(
                (resource: { url: string; description: string }, index: number) => (
                  <LinkUnit
                    key={resource.url}
                    number={index + 1}
                    link={resource.url}
        ...
        {isCourseSelected ? (
          ...
          <div className="flex justify-between pl-[40px] pr-[40px] flex-wrap">
            <VideoPostUnit
              ...
              postId="1"
              courseId="1"
              thumbnail="https://picsum.photos/id/5/264/154"
              likes={1}
              username="person1"
              isLiked={true}
              url={''}
            ...
            <VideoPostUnit
              ...
              postId="2"
              courseId="2"
              thumbnail="https://picsum.photos/id/10/264/154"
              likes={2}
              username="person2"
              isLiked={true}
              url={''}
            ...
            <VideoPostUnit
              ...
              postId="3"
              courseId="3"
              thumbnail="https://picsum.photos/id/15/264/154"
              likes={3}
              username="person3"
              isLiked={false}
              url={''}
