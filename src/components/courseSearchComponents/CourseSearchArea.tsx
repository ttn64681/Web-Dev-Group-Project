    ...
    return (
        <div className="flex w-[100%]" >
            <div className="ml-[10px] mr-[10px]">
                ...
                <input type="text" placeholder="ABCD" className="w-[60px] p-[5px] bg-[#33203A] border-[2px] border-[#6CFEFE] rounded-[10px] text-white placeholder-opacity-40"/>
            </div>
            <div className="ml-[10px] mr-[10px]">
                <h3 className="text-[#765178]">Number</h3>
                <input type="text" placeholder="XXXX" className="w-[60px] p-[5px] bg-[#33203A] border-[2px] border-[#6CFEFE] rounded-[10px] text-white placeholder-opacity-40"/>
            </div>
